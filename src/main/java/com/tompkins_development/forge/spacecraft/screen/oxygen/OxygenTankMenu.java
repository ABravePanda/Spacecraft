...
public class OxygenTankMenu extends AbstractContainerMenu {

    public final OxygenTankBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public OxygenTankMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(0));
    }

    public OxygenTankMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.OXYGEN_TANK_MENU.get(), id);
        checkContainerSize(inv, 0);
        blockEntity = (OxygenTankBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.OXYGEN_TANK.get());
    }
    ...
    public OxygenTankBlockEntity getBlockEntity() {
